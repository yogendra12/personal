		...
		<div class="col-md-12 marLeft7 marginTop15">
			<div class="row setup-content" id="step-1">
				<div class="panel panel-orange">
					<div class="panel-heading panelHead-orange">Your Details</div>
					<div class="panel-body">
						...
						<form role="form">
							...
							<div class="col-xs-12" id="details">
								<div class="col-md-12">
									<p class="text-left" id="yourdetails" style="font-size: 26px;">
										Your Details</p>
									<!-- Select Basic -->
									...
									<div class="form-group">
										<label class="col-md-4 control-label"
											for="service_architecture">Email</label>
										<div class="col-md-5">
											<input id="service_architecture" name="service_architecture"
									...
									<!-- Text input-->
									<div class="form-group">
										<label class="col-md-4 control-label" for="fn">Phone
											Number</label>
										<div class="col-md-5">
									...
									<!-- Text input-->
									<div class="form-group">
										<label class="col-md-4 control-label" for="ln">Secondary
											Number</label>
										<div class="col-md-5">
											<input id="ln" name="ln" type="text"
												placeholder="Secondary Number" class="form-control input-md">
									...
									<div class="form-group">
										<label class="col-md-4 control-label" for="ln">Date of
											Birth</label>
										<div class="col-md-5">
											<input id="example1" name="ln" type="text"
            ...
            <div class="hero-unit">
                <input  type="text" placeholder="click to show datepicker"  id="example1">
									...
									<div class="form-group">
										...
										<div class="col-md-5">
											<input id="cmpny" name="cmpny" type="text"
												placeholder="company" class="form-control input-md">
									...
									<!-- Text input-->
									<div class="form-group">
										<label class="col-md-4 control-label" for="add1">Address
											1</label>
										<div class="col-md-5">
											<input id="add1" name="add1" type="text"
												placeholder="Address 1" class="form-control input-md">
									...
									<!-- Text input-->
									<div class="form-group">
										<label class="col-md-4 control-label" for="add2">Address
											2</label>
										<div class="col-md-5">
											<input id="add2" name="add2" type="text"
												placeholder="Address 2" class="form-control input-md">
									...
									<!-- Text input-->
									<div class="form-group">
										<label class="col-md-4 control-label" for="city">City
											/ Town</label>
										<div class="col-md-5">
									...
									<!-- Text input-->
									<div class="form-group">
										<label class="col-md-4 control-label" for="zip">State
									...
									<!-- Text input-->
									<div class="form-group">
										<label class="col-md-4 control-label" for="zip">Zip /
											Postal Code</label>
										<div class="col-md-5">
									...
									<div class="form-group">
										...
										<div class="col-md-5">
											<select id="ctry" name="ctry" type="text"
												class="form-control input-md">
										...
										<!-- Text input-->
										<div class="form-group">
											<label class="col-md-4 control-label" for="ln">Upload
												old image</label>
											<div class="col-md-5">
									...
									<div class="form-group">
										...
										<div class="col-md-5">
											<textarea id="service_name" name="service_name"
												type="textarea" rows="4" cols="30" placeholder="Description"
							...
							<div class="col-sm-3" style="background-color: white;"
								id="gallery">
								<span style="font-size: 26px;"> Your Images</span>
					...
					<div class="col-sm-12" id="nextbutton">
						<button class="btn btn-primary nextBtn btn-md pull-right marLeft7"
			...
			<div class="row setup-content" id="step-2">
				...
				<div class="col-md-12 spousemargin">
							...
							<div class="col-md-12">
								<div class="col-md-8">
									...
									<div class="form-group col-md-12">
										...
										<div class="col-md-5">
											<textarea id="service_name" name="service_name"
												type="textarea" rows="3" cols="30"
												placeholder="About Spouse" class="form-control input-md"></textarea>
										</div>
									</div>
									<div class="clear-fix"></div>
									<div class="form-group col-md-12">
				...
				<div class="col-md-12 childmargin">

					<div class="panel panel-green">
						<div class="panel-heading panelHead-green">Child Details</div>
						<div class="panel-body">
							<table class="table table-bordered table-hover" id="tab_logic">
								<thead>
									<tr>
										<th class="text-center checkboxfieldwidth">Select</th>
										<th class="text-center photofieldwidth">Photo</th>
										<th class="text-center">Name</th>
										<th class="text-center aboutfieldwidth">About</th>
										<th class="text-center">UploadPhoto</th>
									</tr>
								</thead>
								<tbody>
									<tr id='addr0'>
										<td>
											...
											<p class="checkboxpadding">
												<input type="checkbox" name="number" value="select" />
											</p>
                  ...
                  <input type="text" name='name0'  placeholder='Name' class="form-control"/>
										...
										<td><img src="../images/bird1.png" name="image"
											class="imageSpace photofieldwidth" /></td>
										<td>
											<p class="columnpadding">
                  ...
                  <input type="text" name='eduction' placeholder='Eduction' class="form-control"/>
										...
										<td>
											<p class="columnpadding">
												<input type="file" name='photo' placeholder='Uploadphoto'
													class="form-control" />
											</p>
										</td>
									</tr>
							...
							<a id="add_row" class="btn btn-default pull-left">Add Row</a><a
								id='delete_row' class="pull-right btn btn-default">Delete
								Row</a>
						</div>
					</div>
				</div>
				...
				<div class="col-md-12 childmargin">
					<div class="panel panel-darkBlue">
						<div class="panel-heading panelHead-darkBlue">Upload family
							Photos</div>
						<div class="panel-body">
							<div class="col-md-12">
								<table class="table table-bordered table-hover"
									id="tab_logic_family_photos">
									<thead>
										<tr>
											<th class="text-center checkboxfieldwidth">Select</th>
											<th class="text-center photofieldwidth">Photo</th>
											<th class="text-center photouploadfieldwidth" id="phototh">
												Upload Photo</th>
											<th class="text-center" id="description">Description</th>
											<th class="text-center privacy-field-width">Privacy</th>
									...
									<tbody>
										<tr id='family_photos0'>
											...
											<td>
												<p class="columnpadding">
													<input type="file" name='photo' placeholder='photo'
														class="form-control photouploadfieldwidth"
											...
											<td>
												<p class="privacypadding">
													<input type="checkbox" name='privacy' placeholder='privacy'
														class="form-control privacy-field-width"
														id="checkboxstyle" />
												</p>
											</td>
							...
							<a id="add_row_family_photos" class="btn btn-default pull-left">Add
								Row</a><a id='delete_row_family_photos'
